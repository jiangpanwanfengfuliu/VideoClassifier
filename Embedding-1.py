...
if __name__ == "__main__":
    ...
    data_name = "3-datasets/train-data.csv"
    label_name = "3-datasets/train-labels.csv"
    ...
    model_name = "Video-Classifier-Model.pth"
    ...
    torch.save(torch.concat(data), "4-graphs/temp/train-data.pth")
